                        ...
                        <div class="item-content entry-content">
                            <header class="entry-header">
                                ...
                                <h4 class="entry-title hover-color3">
                                    <a href="blog-single-video-right.html" rel="bookmark">{{$post->title}}</a>
                                </h4>
                    ...
                    <div class="row topmargin_60">
                        <div class="col-sm-12 text-center">
                            ...
                            <ul class="pagination highlightlinks">
                                ...
                                @endif
                                    @for($i = 0, $pageNumber = 1; $i < $totalPosts; $i += $posts->perPage(), $pageNumber++ )
                                        <li><a href="?page={{$pageNumber}}" @if($pageNumber == $posts->currentPage()) class="active" @endif>{{$pageNumber}}</a></li>
                                    @endfor
