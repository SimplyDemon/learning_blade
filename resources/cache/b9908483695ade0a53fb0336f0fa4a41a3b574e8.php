...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(CSS_URL); ?>bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo e(CSS_URL); ?>animations.css">
    <link rel="stylesheet" href="<?php echo e(CSS_URL); ?>fonts.css">
    <link rel="stylesheet" href="<?php echo e(CSS_URL); ?>main.css" class="color-switcher-link">
    <script src="<?php echo e(JS_URL); ?>vendor/modernizr-2.6.2.min.js"></script>

    <!--[if lt IE 9]>
    <script src="<?php echo e(JS_URL); ?>vendor/html5shiv.min.js"></script>
    <script src="<?php echo e(JS_URL); ?>vendor/respond.min.js"></script>
    <script src="<?php echo e(JS_URL); ?>vendor/jquery-1.12.4.min.js"></script>
    <![endif]-->
