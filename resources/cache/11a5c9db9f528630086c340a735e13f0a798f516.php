        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 col-md-8 col-lg-8">
                    ...
                    <article class="vertical-item content-padding big-padding post with_shadow rounded overflow-hidden">


                        <div class="entry-thumbnail">
                            <div>
                                <a href="//player.vimeo.com/video/1084537">
                                    <img src="http://placehold.it/875x595.jpg" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="item-content entry-content">
                            <header class="entry-header">
                                ...
                                <h4 class="entry-title hover-color3">
                                    <a href="blog-single-video-right.html" rel="bookmark"><?php echo e($post->title); ?></a>
                                </h4>
                    ...
                    <div class="row topmargin_60">
                        <div class="col-sm-12 text-center">
                            ...
                            <ul class="pagination highlightlinks">
                                ...
                                <li>
                                    <a href="?page=<?php echo e($posts->currentPage() - 1); ?>">
                                        <span class="sr-only">Prev</span>
                                        <i class="fa fa-angle-left" aria-hidden="true"></i>
                                    </a>
                                </li>
                                <?php endif; ?>
                                    <?php for($i = 0, $pageNumber = 1; $i < $totalPosts; $i += $posts->perPage(), $pageNumber++ ): ?>
                                        <li><a href="?page=<?php echo e($pageNumber); ?>" <?php if($pageNumber == $posts->currentPage()): ?> class="active" <?php endif; ?>><?php echo e($pageNumber); ?></a></li>
                                    <?php endfor; ?>
	                            <?php $totalPages = ceil($totalPosts / $posts->perPage()); ?>
                                <?php if($posts->currentPage() != $totalPages): ?>
                                <li>
                                    <a href="?page=<?php echo e($posts->currentPage() + 1); ?>">
