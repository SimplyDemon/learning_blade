<?php $__env->startSection('content'); ?>
   <section class="intro_section ls ms">
       <img src="<?php echo e(IMAGES_URL); ?>slide01.jpg" alt="">
       <div class="container">
           <div class="row">
               <div class="col-sm-12">
   ...
   <section id="about" class="ls section_padding_top_100 section_padding_bottom_100">
       <div class="container">
           ...
           <div class="row">
               <div class="col-md-6">
                   <img src="<?php echo e(IMAGES_URL); ?>about.jpg" alt="" />
               </div>
               <div class="col-md-6">
                   <p>
           ...
           <div class="row columns_margin_bottom_40">
               <div class="col-md-4 col-sm-6">
                   <div class="teaser text-center">
                       <img src="<?php echo e(IMAGES_URL); ?>services-icons/01.png" alt="" />
                       <h4>
               ...
               <div class="col-md-4 col-sm-6">
                   <div class="teaser text-center">
                       <img src="<?php echo e(IMAGES_URL); ?>services-icons/02.png" alt="" />
                       <h4>
               ...
               <div class="col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-0">
                   <div class="teaser text-center">
                       <img src="<?php echo e(IMAGES_URL); ?>services-icons/03.png" alt="" />
                       <h4>
                   ...
                   <div class="owl-carousel with_shadow_items" data-nav="true" data-dots="false" data-items="3" data-responsive-lg="3" data-margin="30" data-loop="true">
                       ...
                       <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                           <div class="item-media">
                               <img src="<?php echo e(IMAGES_URL); ?>team/01.jpg" alt="">
                           </div>
                           <div class="item-content">
                               <p class="small-text highlight3 margin_0">Pet groomer</p>
                               ...
                               <p>
                                   Theresa is shank pig cow hamburger. Ground round short loin meatbal loin porchetta.
                               </p>
                       ...
                       <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                           <div class="item-media">
                               <img src="<?php echo e(IMAGES_URL); ?>team/02.jpg" alt="">
                           </div>
                           <div class="item-content">
                               <p class="small-text highlight3 margin_0">Cat groomer</p>
                               ...
                               <p>
                                   Rosie is andouille picanha ball tip boudin cow bacon chuck swine pig tri-tip biltong bresaola.
                               </p>
                       ...
                       <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                           <div class="item-media">
                               <img src="<?php echo e(IMAGES_URL); ?>team/03.jpg" alt="">
                           </div>
                           <div class="item-content">
                               <p class="small-text highlight3 margin_0">Dog groomer</p>
                       ...
                       <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                           <div class="item-media">
                               <img src="<?php echo e(IMAGES_URL); ?>team/04.jpg" alt="">
                           </div>
                           <div class="item-content">
                               <p class="small-text highlight3 margin_0">Rabbit groomer</p>
                       ...
                       <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                           <div class="item-media">
                               <img src="<?php echo e(IMAGES_URL); ?>team/05.jpg" alt="">
                           </div>
                           <div class="item-content">
                               <p class="small-text highlight3 margin_0">Cat groomer</p>
                       ...
                       <div class="vertical-item content-padding text-center with_shadow rounded overflow-hidden">
                           <div class="item-media">
                               <img src="<?php echo e(IMAGES_URL); ?>team/06.jpg" alt="">
                           </div>
                           <div class="item-content">
                               <p class="small-text highlight3 margin_0">Rabbit groomer</p>
   ...
   <section id="appointment" class="ds page_appointment background_cover section_padding_top_100 section_padding_bottom_100">
       <div class="container">
           <div class="row">
                   ...
                   <form class="contact-form row columns_margin_bottom_20" method="post" action="./">
                       ...
                       <div class="col-md-4">
                           <div class="form-group">
                               ...
                               <input type="text" aria-required="true" size="30" value="" name="pickup-phone" id="pickup-phone" class="form-control" placeholder="Phone Number">
                           </div>
                       </div>
                       <div class="col-md-2">
                           <div class="form-group select-group">
                               ...
                               <i class="fa fa-calendar highlight3" aria-hidden="true"></i>
                               <select aria-required="true" id="pickup-date" name="pickup-date" class="choice empty form-control">
                       ...
                       <div class="col-md-2">
                           <div class="form-group select-group">
                               ...
                               <i class="fa fa-clock-o highlight3" aria-hidden="true"></i>
                               <select aria-required="true" id="pickup-time" name="pickup-time" class="choice empty form-control">
                       ...
                       <div class="col-sm-12">
                           ...
                           <div class="form-group">
                               ...
                               <textarea aria-required="true" rows="3" cols="45" name="pickup-message" id="pickup-message" class="form-control" placeholder="Message"></textarea>
                           </div>
                       </div>
                       ...
                       <div class="col-sm-12">
                           ...
                           <div class="contact-form-submit topmargin_10">
                               <button type="submit" id="pickup-_submit" name="contact_submit" class="theme_button color3 wide_button">Make an Appointment</button>
                           </div>
                       </div>
       ...
       <div class="container">
           <div class="row">
               ...
               <div class="col-md-6 bottommargin_0">
                   <img src="<?php echo e(IMAGES_URL); ?>mission.png" alt="" class="top-overlap-small" />
               </div>
           </div>
       </div>
   </section>
               ...
               <div class="col-md-10 col-md-offset-1 text-center">
                   ...
                   <div class="owl-carousel testimonials-owl-carousel" data-responsive-lg="1" data-responsive-md="1" data-responsive-sm="1" data-dots="true" data-nav="false">
                       ...
                       <blockquote class="with_quotes text-center">
                           <img src="<?php echo e(IMAGES_URL); ?>faces/01.jpg" alt="" /> With the notion of just how much pet do hate sitting in the groomer's chair, Estelle Marsh undid it all for Enny!
                           <div class="item-meta">
           ...
           <div class="row columns_margin_bottom_20">
               <div class="col-md-4 col-sm-6">
                   <article class="vertical-item content-padding with_shadow text-center rounded overflow-hidden">
                       <div class="item-media">
                           <img src="<?php echo e(IMAGES_URL); ?>gallery/05.jpg" alt="">
               ...
               <div class="col-md-4 col-sm-6">
                   <article class="vertical-item content-padding with_shadow text-center rounded overflow-hidden">
                       <div class="item-media">
                           <img src="<?php echo e(IMAGES_URL); ?>gallery/06.jpg" alt="">
               ...
               <div class="col-md-4 col-sm-6">
                   <article class="vertical-item content-padding with_shadow text-center rounded overflow-hidden">
                       <div class="item-media">
                           <img src="<?php echo e(IMAGES_URL); ?>gallery/07.jpg" alt="">
